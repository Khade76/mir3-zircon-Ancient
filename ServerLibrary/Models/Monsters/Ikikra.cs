...
{
    public class Ikikra : MonsterObject
    {
        ...
        protected override void Attack()
        {
            ...
            ActionList.Add(new DelayedAction(
                               ...
                               damage,
                               AttackElement));
            AttackLocation(Functions.Move(CurrentLocation, Functions.ShiftDirection(Direction, -1)));
            AttackLocation(Functions.Move(CurrentLocation, Functions.ShiftDirection(Direction, 1)));
            AttackLocation(Functions.Move(CurrentLocation, Functions.ShiftDirection(Direction, 2)));
            Bonus = false;
        }
    }
}